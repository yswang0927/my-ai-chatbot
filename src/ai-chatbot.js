                ...
                <div data-ref="input-container" class="ai-chatbot-input-container">
                    ...
                    <div class="ai-chatbot-input-actions">
                        <div class="ai-chatbot-panel-l">
                            ...
                            ${ webSearchEnabled ? '<button data-ref="action-websearch" class="ai-chatbot-btn" data-variant="outline" title="联网搜索"><span class="ai-chatbot-icon">'+ webSearchIcon +'</span><span class="ai-chatbot-btn-text">联网搜索</span></button>' : '' }
